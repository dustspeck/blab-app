exports.Scripts = {
  fetchData: `
    function main() {
      var data = {shared_data:{post_url:null, img_url:null, media_url:null, height:null, width:null, username:null, pp_url:null, is_private:null, is_verified:null, likes_count:null, comments_count:null, caption:null, sidecar:[]}, success:false}
      ...
      if(window.top === window){
        try{
          ...
          data.shared_data.caption = _sharedData.entry_data.PostPage[0].graphql.shortcode_media.edge_media_to_caption.edges[0].node.text;
